...
export const dividerVariants = tv({
  ...
  variants: {
    variant: {
      line: "before:bg-faded-lighter h-0 before:absolute before:top-1/2 before:left-0 before:h-px before:w-full before:-translate-y-1/2",
      "line-spacing": [
        // base
        "h-1",
        // before
        "before:bg-faded-lighter before:absolute before:top-1/2 before:left-0 before:h-px before:w-full before:-translate-y-1/2",
      ],
      "line-text": [
        // base
        "gap-2.5",
        ...
        // before
        "before:bg-faded-lighter before:h-px before:w-full before:flex-1",
        // after
        "after:bg-faded-lighter after:h-px after:w-full after:flex-1",
      ],
      content: [
        // base
        "gap-2.5",
