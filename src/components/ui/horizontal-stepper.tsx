...
function HorizontalStepperSeparatorIcon<T extends React.ElementType>({
  ...
  return <Component className={cn("text-text-soft-400 size-5 shrink-0", className)} {...rest} />;
}
  ...
  variants: {
    state: {
      ...
      default: {
        ...
        indicator: "bg-bg-white-0 text-text-sub-600 ring-stroke-soft-200 ring-1 ring-inset",
      },
    },
  },
  defaultVariants: {
